...
RETURNS @Pedidos TABLE(Unidade INT,	Atendimento INT, Tipo CHAR(1), Codigo INT, Descricao VARCHAR(100), Qde NUMERIC(10,3), Preco NUMERIC(10,2), UN VARCHAR(10), Total NUMERIC(10,2),	Linha VARCHAR(400))
AS
BEGIN
	--Exibir produtos com configuração de Agrupado
	INSERT @Pedidos(Unidade, Atendimento, Tipo, Codigo, Descricao, Qde, Preco, UN, Total)
	SELECT 
		L.Unidade, 
		L.Atendimento,
		'P' as [Tipo],
	...
	GROUP BY L.Unidade, L.Atendimento, R.Produto, Pr.Descrição, Pr.UNE, R.Preço;
